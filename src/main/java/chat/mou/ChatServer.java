...
{
    private final InetSocketAddress hostAddress = new InetSocketAddress(InetAddress.getLoopbackAddress(), 8080);
    ...
    @Autowired
    public ChatServer(ConfigurableApplicationContext applicationContext)
    {
        eventMulticaster =
